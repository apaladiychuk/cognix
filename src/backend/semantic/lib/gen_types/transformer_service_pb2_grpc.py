...
from lib.gen_types.transformer_service_pb2 import SemanticResponse, SemanticRequest
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in transformer_service_pb2_grpc.py depends on'
...
def add_TransformerServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.cognix.TransformerService', rpc_method_handlers)
