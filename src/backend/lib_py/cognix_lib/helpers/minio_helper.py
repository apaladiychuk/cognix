...
class MinIO_Helper:
    @staticmethod
    def download(url: str, temp_path: str, minio_endpoint: str, minio_access_key: str, minio_secret_key: str, minio_use_ssl: bool) -> str:
        """
    ...
    @staticmethod
    def upload_string_to_md(content: str, bucket_name: str, object_name: str, minio_endpoint: str, minio_access_key: str,
